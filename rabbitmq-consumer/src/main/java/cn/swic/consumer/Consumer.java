    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        com.rabbitmq.client.Consumer consumer = new DefaultConsumer(channel){
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                System.out.println("1.consumerTag: "+consumerTag);
                System.out.println("2.Exchange: "+envelope.getExchange());
                System.out.println("3.RoutingKey: "+envelope.getRoutingKey());
                System.out.println("4.properties："+properties);
                System.out.println("5.body: "+new String(body));

            }
        };
        //接收消息
        channel.basicConsume("swic",consumer);
